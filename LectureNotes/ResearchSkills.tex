...
\usepackage[latin1]{inputenc} % uft8?
...
Writing is an essential skill for a professional academic. Scientific progress relies on the communication of (original) scientific results\citep{Tischler1978}. If you are not swayed by the greater good - also your personal recognition, your career, or simply the mark for a report or an essay relies on being able to communicate your work in writing. These things are unlikely to change soon - even in the world of technology, writing will likely remain the most important communication channel in science and many professions beyond. 
...
Writing is a subtle art. As for any art or craft, you will not acquire it by learning the "laws of writing" by heart and following them to the word. To become a skilled writer, you need to understand the art of writing by observation, practice and reflection. Read widely, and think about why some writers appeal to you more. Look critically over your writing, and think about the things that you can improve. This is a process that takes time and requires experience.

Nevertheless, there are some hints that can be given to be more effective in writing, in particular in academic writing. Here are the seven most important ones:
...
\paragraph{Know your audience} Who is going to read what you write? This mostly depends on the journal you choose to publish your work. You need to adjust your text to the knowledge and background of your audience. As \citet{Gopen1990} state "it matters only whether a large majority of the reading audience accurately perceives what the author had in mind".


\paragraph{Know what you want to say}. What is the main message you want to tell people with your paper? Sounds trivial, but in my experience it isn't. Remember: Writing a good paper is not about telling everything you know or have done about a topic -- it is about telling a story and selecting the relevant details. Remember, "if you don't know where you are going,you'll end up someplace else" (Yogi Berra). Before spending hours on writing the wrong text, try to explain a friend in 5-10 min the essential points of piece, and note the structure. If you fail with this, think again about your story.
...
\paragraph{Respect conventions} Most readers are familiar with the conventions of science writing and expect to find arguments, sections and statements in relatively fix positions. That is to say, if the writer respects these structural standards the readability is greatly improved. 
